...
Modelo recomendado: a SPEC é o ponto de maior densidade de decisão técnica do fluxo. Use o modelo mais forte disponível na sessão. Se a sua ferramenta permite escolher modelo por comando, escolha o melhor modelo de planejamento/código disponível; caso contrário, o padrão da sessão costuma bastar.
